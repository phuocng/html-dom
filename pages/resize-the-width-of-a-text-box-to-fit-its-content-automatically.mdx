...
<Demo
    ...
    url="/demo/resize-the-width-of-a-text-box-to-fit-its-content-automatically/index.html"
/>
...
export default ({ children }) => (
    <PostLayout keywords="" title="Resize the width of a text box to fit its content automatically">
        {children}
    </PostLayout>
);
