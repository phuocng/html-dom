...
export default ({ children }) => <PostLayout keywords="scrollIntoView, scrollIntoView behavior smooth, smoothly scroll" title="Scroll to an element">{children}</PostLayout>;
```
