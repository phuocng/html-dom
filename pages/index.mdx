...
<div className="block-home__category"><Heading level={2}>Basic</Heading></div>
...
<div className="block-home__category"><Heading level={2}>Intermediate</Heading></div>
...
<div className="block-home__category"><Heading level={2}>Advanced</Heading></div>
...
<div className="block-home__category"><Heading level={2}>Tip</Heading></div>
