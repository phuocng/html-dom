...
> **Resource**
>
> This [page](https://phuoc.ng/collection/css-layout/centering) introduces the most simple way to center an element in both horizontal and vertical directions

## Handle the event

The layout looks good now. By default, user will see only the loading indicator. We will [hide](https://phuoc.ng/collection/html-dom/show-or-hide-an-element) the loading indicator (or even [remove](https://phuoc.ng/collection/html-dom/remove-an-element) it if you want) as soon as the iframe is loaded:
